...
class EverythingHoopsAPI:
    ...
    def __init__(self):
        ...
        self.players_df = pickle.load(open("backend/data/players_df.pkl", "rb"))
    ...
    def get_statline(self, pts, ast, reb) -> pd.DataFrame:
        ...
        statline = self.games_details_df[(self.games_details_df["PTS"] >= pts) & (self.games_details_df["AST"] >= ast) & (self.games_details_df["REB"] >= reb)]
